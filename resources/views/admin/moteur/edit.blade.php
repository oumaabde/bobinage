                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('moteurs.update',['moteur' => $moteur]) }}" method="post" >
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="custom-select custom-select-md" id="inputMarqueId" name="marque_id" placeholder="Marque" required>
                                      <option value="">Select Marque</option>
                                        @foreach ($marques as $marque )
                                            <option value="{{ $marque->id }}" {{  $moteur->marque_id == $marque->id ? 'selected' : ''  }} >{{ $marque->name }}</option>
                                        @endforeach
                                    ...
                                    <select class="custom-select custom-select-md" id="inputUniteId" name="unite_id" placeholder="Unites" required>
                                      <option value="">Select Unite</option>
                                        @foreach ($unites as $unite )
                                            <option value="{{ $unite->id }}" {{ $moteur->unite_id == $unite->id ? 'selected' : '' }}  >{{ $unite->name ." ( " . $unite->imputation . " )" }}</option>
                                        @endforeach
                                  ...
                                  <div class="form-group col-md-4">
                                      ...
                                      <input type="text"  class="form-control" id="inputNSerie" name="n_serie" value="{{ $moteur->n_serie }}" placeholder="N° Serie" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputPuissance">Puissance</label>
                                      <input type="text"  class="form-control" id="inputPuissance" name="puissance" value="{{ $moteur->puissance }}" placeholder="Puissance" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputCourant">Courant</label>
                                      <input type="text"  class="form-control" id="inputCourant" name="courant" value="{{ $moteur->courant }}" placeholder="Courant" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputVitesse">Vitesse</label>
                                      <input type="text"  class="form-control" id="inputVitesse" name="vitesse" value="{{ $moteur->vitesse }}" placeholder="Vitesse" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputFrequence">Frequence</label>
                                      <input type="text"  class="form-control" id="inputFrequence" name="frequence" value="{{ $moteur->frequence }}" placeholder="Frequence" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputTension">Tension</label>
                                      <input type="text"  class="form-control" id="inputTension" name="tension" value="{{ $moteur->tension }}" placeholder="Tension" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputCosph">Cosph</label>
                                      <input type="text"  class="form-control" id="inputCosph" name="cosph" value="{{ $moteur->cosph }}" placeholder="Cosph" >
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputRoulementA">Roulement A</label>
                                      <input type="text"  class="form-control" id="inputRoulementA" name="roulement_a" value="{{ $moteur->roulement_a }}" placeholder="Roulement A">
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputRoulementB">Roulement B</label>
                                      <input type="text"  class="form-control" id="inputRoulementB" name="roulement_b" value="{{ $moteur->roulement_b }}" placeholder="Roulement B">
                                    </div>
                                    <div class="form-group col-md-4">
                                    <label for="inputCouplage">Couplage</label>
                                    <select class="custom-select custom-select-md" id="inputCouplage" name="couplage" placeholder="Couplage" required>
                                      <option  value="">Select Couplage</option>
                                      <option {{ $moteur->couplage == "traingle" ? 'selected' : '' }}  value="traingle">Traingle</option>
                                    <option {{ $moteur->couplage == "etoile" ? 'selected' : '' }} value="etoile">Etoile</option>
                                    </select> 
                                  </div>
                                    <div class="form-group col-md-4">
