                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <form action="{{ route('unites.update',['unite' => $unite]) }}" method="post" >
                                  ...
                                  <div class="form-group col-md-4">
                                      ...
                                      <input type="text"  class="form-control" id="inputUnite" name="name" value="{{ $unite->name }}" placeholder="Unite Name" required>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="inputUniteImputation">Imputation</label>
                                      <input type="text"  class="form-control" id="inputUniteImputation" name="imputation" value="{{ $unite->imputation }}" placeholder="Unite Imputation" required>
                                    </div>
